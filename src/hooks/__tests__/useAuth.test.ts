...
describe('useAuth', () => {
  ...
  it('should initialize with loading state', async () => {
    vi.mocked(supabase.auth.getSession).mockReturnValueOnce(new Promise(() => {}) as unknown as never)
  ...
  it('should handle successful session', async () => {
    ...
    vi.mocked(supabase.auth.getSession).mockReturnValueOnce(deferred.promise as unknown as never)
