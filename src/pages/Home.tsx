...
// ⚡ Bolt: Memoize InfoPill to prevent unnecessary re-renders when Home component state changes
...
// ⚡ Bolt: Memoize QuickActionCard to prevent unnecessary re-renders when Home component state changes
...
// ⚡ Bolt: Memoize GameCard to prevent unnecessary re-renders when Home component state changes
